...
#include <SoftwareSerial.h> //new added
...
SoftwareSerial mySerial(1,0); // CC2541 TX/RX pins (new added)
...
void DS3231_display(){
  ...
  draw_text(0, 9, Time, 1);                         // Display the time
  draw_text(75, 25, temperature, 1);                  // Display the temperature
  mySerial.println(BPM);  //added to send to bluetooth module
}
...
if((value<LowerThreshold)&(BPMTiming)){
  BeatComplete=true;
//display.writeFillRect(65,9,64,32,BLACK);
